...
import { TEXTBOX_DEFAULT_CONFIG } from "@/features/utils/constants";
import { uuid, loadFont } from "@/features/utils";
import { FText } from "../custom-objects";
...
export const createTextbox = async (options: any) => {
  ...
  const textBox = new FText(text || "panel.text.add", {
